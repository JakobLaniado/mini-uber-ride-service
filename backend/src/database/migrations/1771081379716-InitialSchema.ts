...
export class InitialSchema1771081379716 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."ride_events_from_status_enum" AS ENUM('requested', 'matched', 'driver_arriving', 'in_progress', 'completed', 'cancelled')`);
        await queryRunner.query(`CREATE TYPE "public"."ride_events_to_status_enum" AS ENUM('requested', 'matched', 'driver_arriving', 'in_progress', 'completed', 'cancelled')`);
        await queryRunner.query(`CREATE TABLE "ride_events" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "ride_id" uuid NOT NULL, "from_status" "public"."ride_events_from_status_enum" NOT NULL, "to_status" "public"."ride_events_to_status_enum" NOT NULL, "metadata" jsonb, "timestamp" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a408fbed7f187bf7e160bf19155" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."rides_status_enum" AS ENUM('requested', 'matched', 'driver_arriving', 'in_progress', 'completed', 'cancelled')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_d8ca08acdee36ad9774cbf1c57" ON "rides" ("rider_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_fb13184768dea9734b022874c6" ON "rides" ("driver_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_87b9253c85be51e3785d3653a8" ON "rides" ("status") `);
        await queryRunner.query(`CREATE INDEX "IDX_97f9911b21de0ca819d4bf0f17" ON "rides" ("rider_id", "requested_at") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_009d35735b513a7839455c7d49" ON "drivers" ("is_online") `);
        await queryRunner.query(`CREATE INDEX "IDX_dc6a97760a08fc680af123fb39" ON "drivers" USING GiST ("currentLocation") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_b03f8afdbad12f4170f99603f2" ON "surge_zones" USING GiST ("center") `);
        await queryRunner.query(`ALTER TABLE "ride_events" ADD CONSTRAINT "FK_578f8f74d64f852f842bdb4d453" FOREIGN KEY ("ride_id") REFERENCES "rides"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "ride_events" DROP CONSTRAINT "FK_578f8f74d64f852f842bdb4d453"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b03f8afdbad12f4170f99603f2"`);
        await queryRunner.query(`DROP TABLE "surge_zones"`);
        await queryRunner.query(`DROP TABLE "users"`);
        await queryRunner.query(`DROP TYPE "public"."users_role_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_dc6a97760a08fc680af123fb39"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_009d35735b513a7839455c7d49"`);
        await queryRunner.query(`DROP TABLE "drivers"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_97f9911b21de0ca819d4bf0f17"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_87b9253c85be51e3785d3653a8"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_fb13184768dea9734b022874c6"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d8ca08acdee36ad9774cbf1c57"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."ride_events_from_status_enum"`);
    }
